...
export default function BarcodeLifeline({ events = [] }) {
  ...
  if (careCount === 0) {
    return (
      <div className="w-full aspect-[3/2] flex flex-col items-center justify-center gap-2 px-6 text-center">
  ...
  return (
    <div className="w-full aspect-[3/2] flex flex-col px-5 pt-4 pb-3">
