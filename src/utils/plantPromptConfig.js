...
export const TOOL_DETAILS = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      lietuviskas: {
        type: 'string',
        description: 'LT vardas. PRIORITY ORDER (strict):\n\n1. PRIMARY — jei user message turi line pradedancia "LT name:" RAG context\'e (e.g. "LT name: Trijuoste sansevjera"), grazink TA NAME VERBATIM. Tai musu curated lt-names dictionary (species-lt-names.json + lt-names-overrides.json) authority single source of truth. NIEKADA neLithuanianize\'inti pats jei RAG pateike canonical.\n\n2. FALLBACK — TIK kai RAG NETURI "LT name:" line:\n   • GENUS-level Latin (vienas zodis, e.g. Maranta) → grazink genus LT name kuri zinai (Maranta → "Maranta")\n   • SPECIES-level Latin (du zodziai, e.g. Dracaena trifasciata) → [Genus LT] [Latin epithet]: "Dracaena trifasciata" arba "Dracena trifasciata". Saugesnis nei pats Lithuanianize\'inti adjective.\n   • Jei iset visiskai nezinai LT genus — naudok Latin verbatim ("Tillandsia ionantha").\n\nWARNING — niekada generuok savo Lithuanianized name jei RAG silent — geriau Latin verbatim nei wrong vernacular. Vernacular community kartais keicia rules (Sansevieria→Dracaena 2017 reclass — vernacular keeps "sansevjera", ne "dracena"). Algorithm derived Lithuanianizations kaip "Drakena", "Trijuoste dracena", "Spatifilis" yra HALLUCINATIONS — netinkamas vardo source.',
      },
